...
RSpec.describe CampaignsController, type: :controller do
  ...
  describe "POST #create" do
    ...
    #   expect(Campaign.last.description).to eql("Descreva sua campannha...")
    #   expect(Campaign.last.status).to eql('pending')    
    # end
  ...
  describe "GET #raffle" do
    ...
    context "User is the Campaign Owner" do
      ...
      context "Has more than two members, members => 3" do
        before(:each) do
      ...
      context "No more than two members, members < 3" do
        before(:each) do
          create(:member, campaign: @campaign)
          post :raffle, params: {id: @campaign.id}
        end
